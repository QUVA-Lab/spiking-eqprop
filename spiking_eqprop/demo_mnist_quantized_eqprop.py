...
for X in (X_osa_1hid, X_osa_1hid_longer):
    X.add_root_variant(n_epochs=N_PARAMETER_SEARCH_EPOCHS, epoch_checkpoint_period=None).add_parameter_search(
        space = dict(
...
"""
It seems that optimial Kestens worse than both optimal scheduled and optimal OSA
...
if __name__ == '__main__':
    ...
    experiment_mnist_eqprop_torch.browse(filterexp='has:3_hid', raise_display_errors=True)
